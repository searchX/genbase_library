...
import "package:genbase/src/openai/src/core/utils/extensions.dart";
...
import "../utils/streaming_http_client_default.dart"
    if (dart.library.js) '../utils/streaming_http_client_web.dart'
    if (dart.library.io) '../utils/streaming_http_client_io.dart';
...
class OpenAIChatStreamLineSplitter
  ...
  Stream<String> bind(Stream<String> stream) {
    Stream<String> lineStream = const LineSplitter().bind(stream);
